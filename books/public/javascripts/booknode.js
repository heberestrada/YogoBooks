...
var booksArray = [
    //NEW
                ...
                { 
                    numberBook:45,
                    ES:"Eagle y Malitovich<br> en el derrumbe",
                    EN:"Eagle and Malitovich<br> are Trapped",
                    PT:"Eagle e Malitovich<br> ficam presos",
                    ZH:"伊戈和马利托维奇被困住了",
                    JA:"とじこめられたイーグルとマリトビッチ",
                    KO:"이글이와 <br>말리토비치가 갇혔어요 ",
                    urlImage:"public/books/45",
                    new:true,
                    lock:false
                ...
                { 
                    numberBook:44,
                    ES:"La filosofía<br> de Oof",
                    EN:"Oof's <br>Philosophy",
                    PT:"A filosofia<br> de Oof",
                    ZH:"奥夫的人生观",
                    JA:"ウーフのてつがく",
                    KO:"우프의 철학",
                    urlImage:"public/books/44",
                    new:true,
                    lock:false
                ...
                { 
                    numberBook:43,
                    ES:"Dinamita no <br>quiere ir a la escuela",
                    EN:"Dinamita Doesn't<br> Want to Go to School",
                    PT:"Dinamita não<br> quer ir para a escola",
                    ZH:"迪纳米塔不想去上学",
                    JA:"がっこうへ いきた<br>くない ディナミタ",
                    KO:"다이나미타는 학교에 가기 싫어요",
                    urlImage:"public/books/43",
                    new:true,
                    lock:false
                ...
                { 
                    numberBook:41,
                    ES:"Oona y el<br> concurso de talentos",
                    EN:"Oona and the<br> Talent Show",
                    PT:"Oona e o<br> show de talentos",
                    ZH:"奥娜和才艺秀",
                    JA:"ウーナのはっぴょうかい",
                    KO:"우나와장기자랑",
                    urlImage:"public/books/41",
                    new:true,
                    lock:false
                ...
                { 
                    numberBook:27,
                    ES:"El examen <br>de Tomiko",
                    EN:"Tomiko's<br> Test",
                    PT:"Prova da<br> Tomiko",
                    ZH:"富子的考试",
                    JA:"トミコのテスト",
                    KO:"토미코의 시험",
                    urlImage:"public/books/27",
                    new:true,
                    lock:false
                ...
                { 
                    numberBook:38,
                    ES:"Oof y la<br> piñata",
                    EN:"Oof and the<br> Piñata",
                    PT:"Oof e a<br> pinhata",
                    ZH:"奥夫和皮纳塔彩饰陶罐",
                    JA:"ウーフ と<br> ピニャータ",
                    KO:"우프와<br>피냐타",
                    urlImage:"public/books/38",
                    new:true,
                    lock:false
