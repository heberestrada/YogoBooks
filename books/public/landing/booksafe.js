              ...
              if(language == "ES"){
                  ...
                  $("#book" + i).click(function(){
                      ...
                      if(nombre && nombre!="Yogome" && nombre!=null){
                          ...
                          window.open("master/" +"#" + language + "/"+id  +"/#page/1" + "/&name="+ nombre+"&app="+detectOrigins, "_self"); 
                      }else{
                          window.open("master/" +"#" + language + "/"+id  +"/#page/1" +"/&name=Yogome"+"&app="+detectOrigins, "_self"); 
                      }
                  ...
                  $("#book" + i).click(function(){
                        ...
                        if(nombre && nombre!="Yogome" && nombre!=null){
                         ...
                         window.open("master/" +"#ES" + "/"+id  +"/#page/1" + "/&name="+ nombre+"&app="+detectOrigins, "_self"); 
                      }else{
                          window.open("master/" +"#ES" + "/"+id  +"/#page/1" +"/&name=Yogome"+"&app="+detectOrigins, "_self"); 
                      } 
                  });
              }
